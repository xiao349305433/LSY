...
public class YuvOsdUtils {
    ...
    public static native void initOsd(int osdOffX, int osdOffY
            , int patternLen, int frameWidth, int frameHeight, int rotation, int numWidth, int numHeight);
    ...
    public static native void nv12ToRGB24(byte[] in, byte[] out, int width, int height);
