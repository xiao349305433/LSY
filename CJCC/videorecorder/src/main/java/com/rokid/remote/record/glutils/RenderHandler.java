...
//********************************************************************************
	...
	public final void run() {
		Logger.i( "RenderHandler thread started:");
		synchronized (mSync) {
...
//					mSync.notifyAll();
		...
		Logger.i("RenderHandler thread finished:");
	}

	private final void internalPrepare() {
		Logger.i( "internalPrepare:");
		internalRelease();
