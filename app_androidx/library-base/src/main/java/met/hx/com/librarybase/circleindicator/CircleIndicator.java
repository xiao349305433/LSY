package met.hx.com.librarybase.circleindicator;
...
import met.hx.com.librarybase.circleindicator.holder.ShapeHolder;
...
public class CircleIndicator extends View{
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        if(attrs == null)
            return;
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.baseUtils_CircleIndicator);
        mIndicatorRadius = typedArray.getDimensionPixelSize(R.styleable.baseUtils_CircleIndicator_baseUtils_ci_radius, DEFAULT_INDICATOR_RADIUS);
        mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.baseUtils_CircleIndicator_baseUtils_ci_margin, DEFAULT_INDICATOR_MARGIN);
        mIndicatorBackground = typedArray.getColor(R.styleable.baseUtils_CircleIndicator_baseUtils_ci_background, DEFAULT_INDICATOR_BACKGROUND);
        mIndicatorSelectedBackground = typedArray.getColor(R.styleable.baseUtils_CircleIndicator_baseUtils_ci_selected_background,DEFAULT_INDICATOR_SELECTED_BACKGROUND);
        int gravity = typedArray.getInt(R.styleable.baseUtils_CircleIndicator_baseUtils_ci_gravity,DEFAULT_INDICATOR_LAYOUT_GRAVITY);
        mIndicatorLayoutGravity = Gravity.values()[gravity];
        int mode = typedArray.getInt(R.styleable.baseUtils_CircleIndicator_baseUtils_ci_mode,DEFAULT_INDICATOR_MODE);
