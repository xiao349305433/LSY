package met.hx.com.librarybase.views.dialog;
...
public class MDDialog extends Dialog implements View.OnClickListener{
    ...
    public MDDialog(Context context) {
        super(context, R.style.base_utils_dialog);
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.base_utils_layout_mddialog);
        initWindow();
        initView();
    }
...
//        this.setCanceledOnTouchOutside(true);
    ...
    //是否显示灰暗背景
    public void removeGrayBackground(){
    ...
    private void initView() {
        ...
        ll_container.setBackgroundDrawable(getRoundRectShapeDrawable(getContext(), wrapper.cornerRadiusDp, wrapper.contentBackGround));
    ...
    private static class Wrapper{
        ...
        public int primaryTextColor = Color.parseColor("#000000");
        public int contentTextColor = 0xaa111111;
        public int contentDividerColor = 0x44999999;
        public int contentBackGround = Color.WHITE;
    ...
    public static class Builder {
        ...
        public Builder setContentBackGround(int colorId) {
            wrapper.contentBackGround = wrapper.context.getResources().getColor(colorId);
            return this;
        }
        ...
        public Builder setCanceledOnTouchOutside(boolean touchOutside){
            wrapper.touchOutside = touchOutside ;
            return this ;
        }
        ...
        public Builder setOnKeyListener(DialogInterface.OnKeyListener keyListener){
            wrapper.keyListener = keyListener;
            return this ;
        }
        ...
        public MDDialog create() {
            ...
            dialog.setOnKeyListener(wrapper.keyListener);
            dialog.setCanceledOnTouchOutside(wrapper.touchOutside);
