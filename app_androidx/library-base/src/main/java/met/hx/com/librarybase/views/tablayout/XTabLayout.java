package met.hx.com.librarybase.views.tablayout;
...
public class XTabLayout extends HorizontalScrollView {
   ...
   /*     TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TabLayout,
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.BaseUtilsXTabLayout,
                defStyleAttr, R.style.Widget_Design_TabLayout);

        mTabStrip.setSelectedIndicatorHeight(
                a.getDimensionPixelSize(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabIndicatorHeight, dpToPx(2)));
        mTabStrip.setSelectedIndicatorWidth(
                a.getDimensionPixelSize(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabIndicatorWidth, 0));
        mTabStrip.setSelectedIndicatorColor(a.getColor(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabIndicatorColor, getColorPrimary()));

        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
                .getDimensionPixelSize(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabPadding, 0);
        mTabPaddingStart = a.getDimensionPixelSize(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabPaddingStart,
                mTabPaddingStart);
        mTabPaddingTop = a.getDimensionPixelSize(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabPaddingTop,
                mTabPaddingTop);
        mTabPaddingEnd = a.getDimensionPixelSize(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabPaddingEnd,
                mTabPaddingEnd);
        mTabPaddingBottom = a.getDimensionPixelSize(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabPaddingBottom,
                mTabPaddingBottom);

        xTabTextAllCaps = a.getBoolean(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabTextAllCaps, false);

        mTabTextAppearance = a.getResourceId(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabTextAppearance,
                R.style.TextAppearance_Design_Tab);
        mTabTextSize = a.getDimensionPixelSize(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabTextSize, 0);
        xTabTextBold = a.getBoolean(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabTextBold,false);
        mTabSelectedTextSize = a.getDimensionPixelSize(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabSelectedTextSize, 0);
        xTabTextSelectedBold = a.getBoolean(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabTextSelectedBold,false);
        ...
        if (a.hasValue(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabTextColor)) {
            // If we have an explicit text color set, use it instead
            mTabTextColors = a.getColorStateList(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabTextColor);
        }

        if (a.hasValue(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabSelectedTextColor)) {
            // We have an explicit selected text color set, so we need to make merge it with the
            // current colors. This is exposed so that developers can use theme attributes to set
            // this (theme attrs in ColorStateLists are Lollipop+)
            final int selected = a.getColor(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabSelectedTextColor, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
        }

        xTabDisplayNum = a.getInt(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabDisplayNum, 0);
        mRequestedTabMinWidth = a.getDimensionPixelSize(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabMinWidth,
                INVALID_WIDTH);
        mRequestedTabMaxWidth = a.getDimensionPixelSize(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabMaxWidth,
                INVALID_WIDTH);
        xTabBackgroundColor = a.getColor(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabBackgroundColor, 0);
        xTabSelectedBackgroundColor = a.getColor(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabSelectedBackgroundColor, 0);

        mContentInsetStart = a.getDimensionPixelSize(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabContentStart, 0);
        mMode = a.getInt(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabMode, MODE_FIXED);
        mTabGravity = a.getInt(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabGravity, GRAVITY_FILL);

        dividerWidth = a.getDimensionPixelSize(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabDividerWidth, 0);
        dividerHeight = a.getDimensionPixelSize(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabDividerHeight, 0);
        dividerColor = a.getColor(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabDividerColor, Color.BLACK);
        dividerGravity = a.getInteger(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabDividerGravity, DividerDrawable.CENTER);

        xTabDividerWidthWidthText = a.getBoolean(R.styleable.BaseUtilsXTabLayout_baseUtils_xTabDividerWidthWidthText, false);
