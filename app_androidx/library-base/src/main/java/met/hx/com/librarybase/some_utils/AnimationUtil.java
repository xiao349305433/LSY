...
public class AnimationUtil {
    ...
    /**
     * 平移动画
     * @param fromType 取值: Animation.ABSOLUTE, Animation.RELATIVE_TO_SELF, Animation.RELATIVE_TO_PARENT
     * @param fromXValue
     * @param toXValue
     * @param fromYValue
     * @param toYValue
     ...
     * @return
     */
    public static Animation getTranslateAnimation(int fromType, float fromXValue,float toXValue,
                                                   float fromYValue, float toYValue,long durationMillis) {
        TranslateAnimation translate = new TranslateAnimation(fromType, fromXValue, fromType,  toXValue,
                fromType,  fromYValue, fromType,  toYValue);
        translate.setDuration(durationMillis);
        translate.setFillAfter(true);
        return translate;
    }
