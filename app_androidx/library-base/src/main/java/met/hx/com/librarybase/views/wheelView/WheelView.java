...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xeff4f4f4,
			0xcff4f4f4, 0x3ff4f4f4 };
    /*private int[] SHADOWS_COLORS = new int[] { 0xef000000,
            0xcf000000, 0x3f000000 };*/
    ...
    // Wheel drawables
    private int wheelBackground = R.drawable.base_utils_wheel_bg_common;
    private int wheelForeground = R.drawable.base_utils_wheel_val_common;
    ...
    private int getDesiredHeight(LinearLayout layout) {
        ...
        int desired = itemHeight * visibleItems - itemHeight * ITEM_OFFSET_PERCENT / 50;//布局高度？


        return Math.max(desired, getSuggestedMinimumHeight());// 将计算的布局高度 与 最小高度比较, 取最大值
    }
    ...
    private void drawShadows(Canvas canvas) {
		...
		//*/
        int height = (int)(2 * getItemHeight());//渐变色的高度
        //*/
    ...
    public int px2sp(Context context, float pxValue) {
        ...
        return (int) ((float)phoneWidth / 720 * pxValue);
    }
	 /*if (itemsPaint == null) {
			itemsPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG
					| Paint.FAKE_BOLD_TEXT_FLAG);
			// itemsPaint.density = getResources().getDisplayMetrics().density;
			itemsPaint.setTextSize(px2sp(super.getContext(),30));
		}
    ...
    private void drawItems(Canvas canvas) {
        ...
        canvas.translate(PADDING, - top + scrollingOffset);//平移
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.base_utils_line_border));
        // 设置线宽
        paint.setStrokeWidth((float) 1);
        // 绘制上边直线
        canvas.drawLine(0, center - offset - 1, getWidth(), center - offset - 1, paint);
