...
import static met.hx.com.librarybase.some_utils.ConstUtils.DAY;
import static met.hx.com.librarybase.some_utils.ConstUtils.HOUR;
import static met.hx.com.librarybase.some_utils.ConstUtils.MIN;
import static met.hx.com.librarybase.some_utils.ConstUtils.MSEC;
import static met.hx.com.librarybase.some_utils.ConstUtils.SEC;
...
public class TimeUtils {
    ...
    public static String getDistanceShow(long distance) {
        if (distance < 1000) {
            return distance + "m";
        } else {
