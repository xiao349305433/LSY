...
import wu.loushanyun.com.fivemoduleapp.v.fragment.FirstWelcomeFragment;
import wu.loushanyun.com.fivemoduleapp.v.fragment.SecondWelcomeFragment;

@Route(path = K.WelcomeActivity)
public class WelcomeActivity extends BaseNoPresenterActivity {
    ...
    protected void onInitAttribute(BaseAttribute ba) {
        getAllData();
        ba.mActivityLayoutId = R.layout.m_five_welcome_activity;
    ...
    protected void initView() {
        ...
        abViewPager.setCurrentItem(position);
    }
    @NonNull
