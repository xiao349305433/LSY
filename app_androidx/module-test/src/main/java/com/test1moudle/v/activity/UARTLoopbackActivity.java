...
@Route(path = C.UARTLoopbackActivity)
public class UARTLoopbackActivity extends Activity {
	...
	protected void restorePreference() {
		...
		if(true == bConfiged){			
			...
			case 2400:baudSpinner.setSelection(3);break;
			case 4800:baudSpinner.setSelection(4);break;
			case 9600:baudSpinner.setSelection(5);break;
			case 19200:baudSpinner.setSelection(6);break;
			case 38400:baudSpinner.setSelection(7);break;
			case 57600:baudSpinner.setSelection(8);break;
			case 115200:baudSpinner.setSelection(9);break;
			case 230400:baudSpinner.setSelection(10);break;
			case 460800:baudSpinner.setSelection(11);break;
			case 921600:baudSpinner.setSelection(12);break;
