...
public class MultiTypeAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void replaceAllAndNotify(Collection list) {
        if (items != null) {
    ...
    public void addAllAndNotify(Collection list) {
        if (items != null) {
            if (list != null && list.size() > 0) {
                items.addAll(list);
                notifyDataSetChanged();
    ...
    public void addAllAndNotify(int position, Collection list) {
        if (items != null) {
            if (list != null && list.size() > 0) {
    ...
    public void setItemsAndNotify(@NonNull List<?> items) {
        this.items = items;
        notifyDataSetChanged();
    }
