 ...
 */
public abstract class PBaseBottomTabActivity<T extends BasePresenter> extends BaseYesPresenterActivity implements
    ...
    protected T mBottomTabPresenter;
    ...
    protected void initLifeCycle() {
        super.initLifeCycle();
        mBottomTabPresenter = (T) initPresenter();
        registerLifeCycle(mBottomTabPresenter);
    }
    ...
    protected void initView() {
        ArrayList<Fragment> arr=addFragment();
        if (arr != null) {
            if (arr.size() > 0) {
