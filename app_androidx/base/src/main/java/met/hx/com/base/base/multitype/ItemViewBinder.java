 ...
 * @author drakeet
 */
public abstract class ItemViewBinder<T, VH extends RecyclerView.ViewHolder> extends PushNetWork {
    ...
    protected void onViewAttachedToWindow(VH viewHolder) {
     ...
     * @return
     */
    protected T getContentByViewHolder(RecyclerView.ViewHolder baseHolder) throws Exception{
        T content = (T) getAdapter().getItems().get(baseHolder.getAdapterPosition());
        return content;
    }

    protected void onViewDetachedFromWindow(VH viewHolder) {

    }

    protected void onViewRecycled(VH viewHolder) {
