...
//    private LinearLayout reFreshTimeLayout;//显示上次刷新时间的layout
 ...
 //   private Long refreshTime = null;
    ...
    private void init() {
        ...
        //刷新视图顶端的的view
         refreshView = LayoutInflater.from(mContext).inflate(R.layout.base_refresh_top_item, null);
        //指示器view
        ...
        finish_iv = (ImageView) refreshView.findViewById(R.id.finish_iv);
        //下拉显示text
...
//         reFreshTimeLayout=(LinearLayout)refreshView.findViewById(R.id.refresh_time_layout);
        ...
        releaseTextString = mContext.getResources().getString(R.string.base_pull_to_refresh_release_label);
    }
...
//        }
    ...
    private void refresh() {
        ...
        finish_iv.setVisibility(View.GONE);
        downTextView.setText(R.string.base_pull_to_refresh_refreshing_label);
...
//        }
        ...
        finish_iv.setVisibility(View.GONE);
        if(lp.topMargin >  0){
            downTextView.setText(R.string.base_pull_to_refresh_release_label);
            //refreshIndicatorView.setImageResource(R.drawable.refresh_arrow_up);
        }else{
            downTextView.setText(R.string.base_pull_to_refresh_pull_label);
    ...
    public void finishRefresh(){
        ...
        finish_iv.setImageDrawable(getResources().getDrawable(R.drawable.base_image_pulltorefresh_success));
        downTextView.setText(getContext().getString(R.string.base_pull_refresh_success));
         LayoutParams lp= (LayoutParams)this.refreshView.getLayoutParams();
            int i = lp.topMargin;
            //refreshIndicatorView.setVisibility(View.VISIBLE);
            //timeTextView.setVisibility(View.VISIBLE);
