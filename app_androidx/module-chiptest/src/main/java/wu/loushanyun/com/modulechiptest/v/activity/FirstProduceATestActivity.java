...
@Route(path = K.FirstProduceTestActivity)
public class FirstProduceATestActivity extends BaseSnBlueToothActivity {
    private Spinner xindaoSelect;
    ...
    protected int onChildLayout() {
        return R.layout.m_chip_activity_firstproduce;
    }
    ...
    protected void initView() {
        super.initView();
        xindaoSelect = (Spinner) findViewById(R.id.xindao_select);
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(FirstProduceATestActivity.this, R.layout.l_loushanyun_item_spinner, sAtInstructRealizeFactory.getAllMoShi());
        xindaoSelect.setAdapter(arrayAdapter);
        xindaoSelect.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                AbSharedUtil.putString(FirstProduceATestActivity.this,"snmoshi",xindaoSelect.getSelectedItem().toString());
            }
        ...
        if(!XHStringUtil.isEmpty(AbSharedUtil.getString(this,"snmoshi"),true)){
            xindaoSelect.setSelection(sAtInstructRealizeFactory.getMoShiIndex(AbSharedUtil.getString(this,"snmoshi")));
        }
        ...
        snPrintViewBinder = new SnPrintViewBinder(new SnPrintViewBinder.OnSnPrintListener() {
            ...
            public void onSetXinDao(int position) {
                ...
                if (clickSnPrintInfo.getSensoroDevice().equals(sensoroDevice)) {
                    ...
                    try {
                        snBlueToothTool.write(sAtInstructRealizeFactory.setsAtParams(SAtInstructParams.sAtInstructChannel).getTwoWriteBytes(xindaoSelect.getSelectedItem().toString().trim()), "设置信道");
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                } else {
...
//                    }
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("去分享", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Uri uri = FileProvider.getUriForFile(FirstProduceATestActivity.this, "wu.loushanyun.com.modulechiptest.fileprovider", file);
                                    new Share2.Builder(FirstProduceATestActivity.this)
                                            .setContentType(ShareContentType.FILE)
                                            .setShareFileUri(FileUtil.getFileUri(FirstProduceATestActivity.this, ShareContentType.FILE, file))
                                            .setTitle("打印SN")
    ...
    public void onChildNotify(byte[] result) {
        ...
        switch (code) {
            case 0x50:
                ...
                XLog.i("蓝牙" + resultAt);
                if (resultAt.equals(SAtInstructParams.sAtInstructChannel + "-W")) {
                    try {
            ...
            case 0x11:
                try {
                    ...
                    initSnAgreement(Double.valueOf(LouShanYunUtils.getSoftWareVersion(Integer.valueOf(hashMap.get(MapParams.软件版本)))));
                    if (type == 1) {
                        snBlueToothTool.write(sAtInstructRealizeFactory.setsAtParams(SAtInstructParams.sAtInstructChannel).getFourWriteBytes(xindaoSelect.getSelectedItem().toString().trim()), "设置信道");
    ...
    private void setDuQu(HashMap<String, String> hashMap,SnPrintInfo snPrintInfo) {
        ...
        factoryProductionInfo.setChannel(xindaoSelect.getSelectedItem().toString().trim());
        factoryProductionInfo.setCollectionScene(1);//采集场景 1 基站民用 2 基站公用 3第三方公用 4第三方家用用
        factoryProductionInfo.setEquipmentType(1);//1号对 1，2号对 2，4号对4
