...
public class CheckFourSimuActivity extends BaseSnBlueToothActivity {
    ...
    protected int onChildLayout() {
        return R.layout.m_chip_activity_checkfoursimu;
    }
    ...
    protected void initView() {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(CheckFourSimuActivity.this, R.layout.l_loushanyun_item_spinner, sAtInstructRealizeFactory.getAllMoShi());
        atXindaocanshuSelect.setAdapter(arrayAdapter);
        ArrayAdapter<String> arrayAdapterJiaoHu = new ArrayAdapter<String>(CheckFourSimuActivity.this, R.layout.l_loushanyun_item_spinner, FourSimuBlueToothUtil.getAllWangLuoJiaoHu());
        wangluojiaohuSelect.setAdapter(arrayAdapterJiaoHu);
        ArrayAdapter<String> arrayAdapter1 = new ArrayAdapter<String>(CheckFourSimuActivity.this, R.layout.l_loushanyun_item_spinner, FourSimuBlueToothUtil.getAllPinLv());
        pinlvSelect.setAdapter(arrayAdapter1);
        ArrayAdapter<String> arrayAdapterDYLX = new ArrayAdapter<String>(CheckFourSimuActivity.this, R.layout.l_loushanyun_item_spinner, FourSimuBlueToothUtil.getDianYuanLeiXing());
        dianyuanSelect.setAdapter(arrayAdapterDYLX);
        ArrayAdapter<String> arrayAdapterMoShi = new ArrayAdapter<String>(CheckFourSimuActivity.this, R.layout.l_loushanyun_item_spinner, FourSimuBlueToothUtil.getChuanGanMoShi());
        chuanganmoshiSelect.setAdapter(arrayAdapterMoShi);
        ArrayAdapter<String> arrayAdapterShuZi = new ArrayAdapter<String>(CheckFourSimuActivity.this, R.layout.l_loushanyun_item_spinner, FourSimuBlueToothUtil.getChuanGanXinHaoShuZi(ChooseMoshiLeiJi));
    ...
    private void OnClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.text_token:
                ...
                new Share2.Builder(CheckFourSimuActivity.this)
