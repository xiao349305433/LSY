...
@Route(path = K.ThirdTestJiZhongQiActivity)
public class ThirdTestJiZhongQiActivity extends BaseBlueToothActivity {
        ...
        switch (code) {
            case 0x09:
                if (output[7] == 0) {
                    ...
                    runOnUiThread(() -> editIdStart.setText(LouShanYunUtils.getTimeID()));
                } else {
