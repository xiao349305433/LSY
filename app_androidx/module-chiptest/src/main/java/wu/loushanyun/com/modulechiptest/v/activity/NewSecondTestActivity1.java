...
@Route(path = K.NewSecondTestActivity1)
public class NewSecondTestActivity1 extends BaseSnBlueToothActivity {
    ...
    protected int onChildLayout() {
        return R.layout.m_chip_activity_second_test2;
    }
    ...
    protected void initView() {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(NewSecondTestActivity1.this, R.layout.l_loushanyun_item_spinner, sAtInstructRealizeFactory.getAllMoShi());
    ...
    private void OnClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.text_token:
                ...
                new Share2.Builder(NewSecondTestActivity1.this)
