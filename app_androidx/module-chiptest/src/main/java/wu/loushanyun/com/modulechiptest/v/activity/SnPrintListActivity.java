...
@Route(path = K.SnPrintListActivity)
public class SnPrintListActivity extends BaseSnBlueToothActivity {
        ...
        snPrintViewBinder = new SnPrintViewBinder(new SnPrintViewBinder.OnSnPrintListener() {
            ...
            public void onUpData(int position) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        pushEvent(ChipCode.MChipModuleFactoryProduction, new Gson().toJson(factoryProductionInfos.get(position)), snPrintInfos.get(position).getNum(),
    ...
    protected void initView() {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(SnPrintListActivity.this, R.layout.l_loushanyun_item_spinner, sAtInstructRealizeFactory.getAllMoShi());
        ...
        xindaocanshuSelect.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                AbSharedUtil.putString(SnPrintListActivity.this, "snmoshi", xindaocanshuSelect.getSelectedItem().toString());
            }
        ...
        if (!XHStringUtil.isEmpty(AbSharedUtil.getString(this, "snmoshi"), true)) {
            xindaocanshuSelect.setSelection(sAtInstructRealizeFactory.getMoShiIndex(AbSharedUtil.getString(this, "snmoshi")));
        }
    }
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("去分享", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Uri uri = FileProvider.getUriForFile(SnPrintListActivity.this, "wu.loushanyun.com.modulechiptest.fileprovider", file);
                                    new Share2.Builder(SnPrintListActivity.this)
                                            .setContentType(ShareContentType.FILE)
                                            .setShareFileUri(FileUtil.getFileUri(SnPrintListActivity.this, ShareContentType.FILE, file))
                                            .setTitle("打印SN")
    ...
    public void onChildNotify(byte[] result) {
        ...
        switch (code) {
            case 0x50:
                ...
                if (resultAt.equals(SAtInstructParams.sAtInstructRxDelay + "-W")) {
                    try {
                        sendMessageToast("RxDelay设置成功");
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    ...
                    try {
                        ...
                        try {
                            if (!isOnlySet) {
                                snBlueToothTool.write(sAtInstructRealizeFactory.setsAtParams(SAtInstructParams.sAtInstructSendingPower).getTwoWriteBytes("20dbm"), "设置发送功率");
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    ...
                    try {
                        ...
                        try {
                            ...
                            //   snBlueToothTool.write(sAtInstructRealizeFactory.setsAtParams(SAtInstructParams.sAtInstructSpreadingFactor).getTwoWriteBytes("SF9"), "设置扩频因子");
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    } catch (Exception e) {
...
//                        setDefaultFactoryParams();
    ...
    private void setDuQu(HashMap<String, String> hashMap, SnPrintInfo snPrintInfo) {
        ...
        factoryProductionInfo.setHardwareVersion(LouShanYunUtils.getHardWareVersion(Integer.parseInt(hashMap.get(MapParams.硬件版本))));
        factoryProductionInfo.setSoftVersion(LouShanYunUtils.getSoftWareVersion(Integer.parseInt(hashMap.get(MapParams.软件版本))));
...
//        factoryProductionInfo.setRssi(-66);
//        factoryProductionInfo.setSnr(6);
