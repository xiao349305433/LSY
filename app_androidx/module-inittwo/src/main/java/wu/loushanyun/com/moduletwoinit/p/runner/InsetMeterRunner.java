...
public class InsetMeterRunner extends CommonRunner{

    @Override
    public void onEventRun(Event event) {
        Request<String> request = NoHttp.createStringRequest(URLUtils.getIP() + URLUtils.MInitTwoInsetAreaMeter, RequestMethod.POST);
