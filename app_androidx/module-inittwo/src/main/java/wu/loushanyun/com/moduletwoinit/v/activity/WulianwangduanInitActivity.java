...
@Route(path = K.WulianwangduanInitActivity)
public class WulianwangduanInitActivity extends BaseBlueToothActivity implements View.OnClickListener {
            ...
            public boolean onLongClick(View v) {
                if (onetoOneConverter.getImagePath() != null) {
                    ...
                    ARouter.getInstance().build(C.FullViewPictureActivity)
                            ...
                            .navigation(WulianwangduanInitActivity.this);
                }
                return true;
            }
        });
