...
import static com.gpsdk.demo.Constant.CONN_STATE_DISCONN;
...
import static com.gpsdk.demo.ListViewAdapter.CONN_METHOD;
import static com.gpsdk.demo.ListViewAdapter.MESSAGE_CONNECT;
...
public class ConnMoreDevicesActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.lv_printer_lists);
    ...
    private List<Map<String, Object>> getOperateItemData() {
        ...
        int[] PrinterImage = new int[]{R.mipmap.ic_printer, R.mipmap.ic_printer, R.mipmap.ic_printer,
                R.mipmap.ic_printer};
