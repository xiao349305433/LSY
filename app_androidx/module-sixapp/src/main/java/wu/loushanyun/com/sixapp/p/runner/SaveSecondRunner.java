...
public class SaveSecondRunner extends SixCommonRunner{
    @Override
    public void onEventRun(Event event) {
        String testdata= (String) event.getParamAtIndex(0);
        HashMap<String, Object> params = new HashMap();
        params.put("testUpData", testdata);
        Request<String> request= NoHttp.createStringRequest(URLUtils.getIP() + URLUtils.MSixSaveSecond, RequestMethod.POST);
        request.add(params);
