...
public class SaveFirstRunner extends SixCommonRunner{
    @Override
    public void onEventRun(Event event) {
        String testdata= (String) event.getParamAtIndex(0);
        HashMap<String, Object> params = new HashMap();
        params.put("testUpData", testdata);
        Request<String> request= NoHttp.createStringRequest(URLUtils.getIP() + URLUtils.MSixSaveFirst, RequestMethod.POST);
        request.add(params);
