...
public class GetCodeRunner extends SixCommonRunner{
    @Override
    public void onEventRun(Event event) {
        String tel= (String) event.getParamAtIndex(0);
        Request<String> request= NoHttp.createStringRequest(URLUtils.getIP() + URLUtils.MSixGetVerificationCode, RequestMethod.POST);
        request.add("tel", tel);
