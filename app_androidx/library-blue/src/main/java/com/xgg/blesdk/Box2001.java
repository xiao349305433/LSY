...
public abstract class Box2001 {
    ...
    //光电直读的characteristic
    protected String m_str_writechara_gd = "0000ff21-0000-1000-8000-00805f9b34fb";
    protected String m_str_readchara_gd = "0000ff2f-0000-1000-8000-00805f9b34fb";
...
//		BluetoothGattDescriptor descriptor = characteristic.getDescriptor(UUID.fromString("0000ff2f-0000-1000-8000-00805f9b34fb"));
        if (descriptor != null) {
